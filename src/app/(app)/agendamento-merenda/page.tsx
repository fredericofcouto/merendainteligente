...
import { AgendamentoForm } from '@/components/merenda/AgendamentoForm';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardDescription, CardHeader, CardTitle, CardFooter } from '@/components/ui/card';
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@/components/ui/table';
import { CalendarCheck, ListChecks, AlertTriangle, Trash2, Info } from 'lucide-react';
...
export default function AgendamentoMerendaPage() {
  ...
  const handleAgendamentoSubmit = (data: { date: Date; mealType: MealType }) => {
    startTransition(() => {
      try {
        // Check for existing agendamento for the same date and meal type
    ...
    <div className="space-y-8">
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>Visualize e gerencie seus agendamentos de merenda.</CardDescription>
        </CardHeader>
        <CardContent>
